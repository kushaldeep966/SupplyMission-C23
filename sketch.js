...
function setup() {
	...
	box2Sprite=createSprite(280,608,20,100);
	box2Sprite.shapeColor=color("red")

	box3Sprite=createSprite(470,608,20,100);
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 box2 = Bodies.rectangle(280,608,20,100,{isStatic:true} );
	 World.add(world, box2); 

	 box3 = Bodies.rectangle(470,608,20,100,{isStatic:true} );
